...
//    }
    ...
    public function servicio($servicio) {
        ...
        switch ($servicio) {
            case "ocupacional":
                $pagina='ocupacional_view';
                break;
            case "ocupacional_ingreso":
                $pagina='ocupacional_ingreso_view';
                break;
            case "ocupacional_periodico":
                $pagina='ocupacional_periodico_view';
                break;
            case "ocupacional_retiro":
                $pagina='ocupacional_retiro_view';
                break;
            case "ocupacional_osteomuscular":
                $pagina='ocupacional_osteomuscular_view';
                break;     
            case "ocupacional_altura":
                $pagina='ocupacional_altura_view';
                break;
            case "ocupacional_alimento":
                $pagina='ocupacional_alimento_view';
                break;
            case "audiometria":
                $pagina='audiometria_view';
                break;
            case "visiometria":
                $pagina='visiometria_view';
                break;
            case "espirometria":
                $pagina='espirometria_view';
                break;
            case "electrocardiograma":
                $pagina='electrocardiograma_view';
                break;             
            default:
        ...
        $this->load->view('general/header_view');
        $this->load->view('servicio/'.$pagina);
        $this->load->view('general/footer_view');
    }
